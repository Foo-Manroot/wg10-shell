...
#        )
    ...
    def encrypt (self, command):
        ...
        print ("Data:      '{:s}'".format (binascii.hexify (data).decode ("utf-8")))
        print ("Encrypted: '{:s}'".format (binascii.hexify (encrypted).decode ("utf-8")))
        print ("Signature: '{:s}'".format (binascii.hexify (signature).decode ("utf-8")))
